...
const schemaStatements = [
  ...
  `CREATE TABLE IF NOT EXISTS transfers (id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, code TEXT NOT NULL UNIQUE, from_store TEXT NOT NULL, to_store TEXT NOT NULL, sender TEXT NOT NULL, receiver TEXT NOT NULL, carrier TEXT NOT NULL, transport_reason TEXT NOT NULL, created_by INTEGER NOT NULL REFERENCES users(id), created_at TEXT NOT NULL)`,
