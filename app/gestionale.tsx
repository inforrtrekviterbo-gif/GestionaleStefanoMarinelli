...
function Customers({ data, reload }: { data: Bootstrap; reload: () => Promise<void> }) {
  ...
  const [newOpen, setNewOpen] = useState(false); const [editing, setEditing] = useState(false); const [error, setError] = useState("");
