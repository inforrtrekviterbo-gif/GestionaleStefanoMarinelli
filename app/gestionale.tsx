...
import NewCashRegister, { localFiscalBridgeRequest, type CartItem as ShellCartItem, type PendingCashAction } from "./cash-register";
...
function Returns({ data }: { data: Bootstrap }) {
  const [query, setQuery] = useState("");
  ...
  return <section className="screen"><div className="screen-head"><div><h1>Resi</h1><p className="muted inventory-intro">Registro dei resi e cambi registrati in cassa.</p></div></div>
