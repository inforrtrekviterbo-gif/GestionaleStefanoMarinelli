...
const adminMenuGroups: { label: string; items: readonly (readonly [string, string, string])[] }[] = [
  ...
  { label: "Anagrafiche", items: [["customers", "group", "Clienti"], ["gifts", "card_giftcard", "Buoni regalo"], ["reservations", "event_note", "Prenotazioni e acconti"], ["services", "handyman", "Servizi"]] },
...
const cashierMenuGroups: { label: string; items: readonly (readonly [string, string, string])[] }[] = [
  ...
  { label: "Magazzino", items: [["warehouse", "inventory_2", "Magazzino"], ["reorder", "warning", "Da riordinare"], ["transfers", "swap_horiz", "Trasferimenti"]] },
  { label: "Anagrafiche", items: [["customers", "group", "Clienti"], ["reservations", "event_note", "Prenotazioni e acconti"]] },
];
