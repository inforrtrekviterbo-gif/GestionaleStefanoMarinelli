...
const adminMenu = [["dashboard", "dashboard", "Riepilogo"], ["warehouse", "inventory_2", "Magazzino"], ["cash", "point_of_sale", "Cassa"], ["customers", "group", "Clienti"], ["transfers", "swap_horiz", "Trasferimenti"], ["documents", "receipt_long", "Fatturazione"], ["register", "list_alt", "Registro casse"], ["reports", "summarize", "Corrispettivi"], ["gifts", "card_giftcard", "Riepilogo buoni regalo"], ["reservations", "event_note", "Prenotazioni e acconti"], ["analytics", "trending_up", "Analisi vendite"], ["fiscal", "print", "Registratori RT"], ["settings", "settings", "Impostazioni"]] as const;
