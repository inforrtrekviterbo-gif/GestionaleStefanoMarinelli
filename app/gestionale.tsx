...
type Bootstrap = { user: User; products: Product[]; customers: Customer[]; sales: Sale[]; gifts: Gift[]; reservations: Reservation[]; transfers: Transfer[]; documents: BusinessDocument[]; saleItems?: SaleItemSummary[]; fiscalDevices: FiscalDevice[]; fiscalJobs: FiscalJob[]; generatedAt: string; services: { id: number; name: string; price: number; active: number }[] };
