...
import NewCashRegister, { localFiscalBridgeRequest, type CartItem as ShellCartItem } from "./cash-register";
...
function ReservationSummary({ data, reload, repair = false }: { data: Bootstrap; reload: () => Promise<void>; repair?: boolean }) {
...
export default function Gestionale() {
  ...
  const content: Record<string, ReactNode> = { dashboard: <Dashboard data={data} />, cash: <NewCashRegister data={data} reload={reload} queue={saleQueue} onQueueConsumed={() => setSaleQueue([])} cart={cart} setCart={setCart} />, customers: <Customers data={data} reload={reload} />, warehouse: <Warehouse data={data} reload={reload} />, inventory: <Inventory data={data} />, reorder: <ReorderList data={data} reload={reload} />, transfers: <Transfers data={data} reload={reload} newResponses={newResponses} />, load: <QuickLoad data={data} reload={reload} />, documents: <Documents data={data} reload={reload} />, register: <Register data={data} />, reports: <CashReports data={data} />, gifts: <GiftSummary data={data} reload={reload} />, reservations: <ReservationSummary data={data} reload={reload} />, repairs: <ReservationSummary data={data} reload={reload} repair />, returns: <Returns data={data} />, analytics: <Analytics data={data} />, storico: <ActivityLog />, fiscal: <FiscalRegisters data={data} reload={reload} />, settings: <Settings reload={reload} />, services: <Services data={data} reload={reload} /> };
